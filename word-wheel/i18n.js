...
(function (root) {
  ...
  const STR = {
    en: {
      ...
      gotoTitle: 'Go to a level', gotoBody: 'Choose any level you have reached, from 1 to {n}.', go: 'Go', cancel: 'Cancel',
    ...
    es: {
      ...
      gotoTitle: 'Ir a un nivel', gotoBody: 'Elige cualquier nivel que ya alcanzaste, del 1 al {n}.', go: 'Ir', cancel: 'Cancelar',
    ...
    vi: {
      ...
      gotoTitle: 'Đến một màn', gotoBody: 'Chọn màn bạn đã tới, từ 1 đến {n}.', go: 'Đi', cancel: 'Hủy',
